...
export function iconForElement(kind) {
    switch (kind) {
        case "button":
...
export function buttonWithIcon(form, text, iconPath) {
...
export function optionalIcon(iconPath) {
    if (!isWorkingIconPath(iconPath))
        return undefined;
    return iconPath;
}
export function newModalForm(title, submit = "Submit") {
